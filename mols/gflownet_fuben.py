...
class TreeNode:
    ...
    def get_value(self, c_puct, a): # 此处的a是没有分到各个反应位点的a
        ...
        # print((self._children[a]._Q), '##############', u)
        
        return (self._children[a]._Q) + u**10
...
class Dataset:
    ...
    def get_move(self, n_playout, path, m, current_step):
        ...
        visit_counts = torch.tensor(
            [child._n_visits for _, child in current_node._children.items()],
...
def main(args):
    print("##################initial_epsilon = 0, final_epsilon = 0.1, transition_step = 2000,q+u**10##########################")
    pid = os.getpid()
